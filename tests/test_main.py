...
from main import \
    calculate_and_print  # Ensure this import matches your project structure
...
@pytest.mark.parametrize("a_string, b_string, operation_string, expected_string", [
    ...
    ("a", "3", 'add', "Invalid number input: a or 3 is not a valid number."),  #Testing invalid no
    ("5", "b", 'subtract', "Invalid number input: 5 or b is not a valid number.")  
    #Testing invalid no
])
#for Calculater print
